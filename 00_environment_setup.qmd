...
At the end of the session, you will learn R basics using Google Colab <img src="images/icon-google-colab.svg" alt="" style="display: inline; height: 1.5em; vertical-align: bottom;" />.
...
Use [THIS LINK](https://colab.research.google.com/drive/1cpY6EGpNrqwIz-7ZITTQHZie3BPV-BpF?usp=sharing) to open the R Notebook in Google Colab. Follow the instructions in the notebook to complete the exercises.
