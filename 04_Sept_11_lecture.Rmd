...
Let $\overline{X}=\sum_{i=1}^n X_i.$ 

We have shown in the last lecture that $\mathbb{E}[\overline{X}]=\mu$ and $\text{Var}[\overline{X}]=\sigma^2/n$ (Refer to the expectation and variance of the sample mean).
...
A <span style='color:#008B45FF'>**confidence interval**</span> combines both the <span style='color:#337ab7'>value</span> of the estimator and the <span style='color:#337ab7'>variance</span> of that estimator, thereby reflecting <span style='color:#337ab7'>estimation uncertainty</span>.
