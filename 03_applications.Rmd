...
Plot histogra, empirical density, and compare with normal density (in blue).
```{r}
...
A QQ plot is a scatter plot created by plotting two sets of quantiles against one another. If both sets of quantiles came from the same distribution, we should see the points forming a line that's roughly straight. 
...
- You can take more samples, you take $1,000$ people from each of $9$ other cities, for instance, Oslo, Bergen. The you calculate the sample average for each city. Now you have $10$ sample averages from $10$ cities.
