...
::: {.example #exm-10}
An electronics store sells 0, 1, or 2 laptops on a given day. Let $X$ be the number sold on a randomly chosen day:

$$
P(X=0)=0.2, \qquad P(X=1)=0.5, \qquad P(X=2)=0.3.
$$

Compute $\text{Var}(X)$ using the shortcut formula $\mathbb{E}[X^2] - (\mathbb{E}[X])^2$.
:::
