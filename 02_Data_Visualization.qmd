...
| `grades`      | Factor indicating grade span covered by the district’s schools. <br />It takes on two values: <br />- `KK-06`: means the district’s schools serve kindergarten through 6th grade.<br />- `KK-08`: means the district’s schools serve kindergarten through 8th grade. |
...
- Notice the **range of expenditure** per student: from around [\$3,900]{.mathjax_ignore} to over [\$7,700]{.mathjax_ignore} - this substantial variation will be a key focus of our analysis
...
- **Range:** Expenditure varies from about [\$3,926]{.mathjax_ignore} to [\$7,712]{.mathjax_ignore} per student - a difference of nearly [\$4,000]{.mathjax_ignore}
- **Central Tendency:** The mean ([\$5,312]{.mathjax_ignore}) is slightly higher than the median ([\$5,196]{.mathjax_ignore}), **suggesting a slight right skew**
- **Variability:** Standard deviation of [\$633]{.mathjax_ignore} indicates moderate spread around the mean
...
- Most districts cluster around the [\$5,000]{.mathjax_ignore}–[\$5,500]{.mathjax_ignore} range
...
- **K–6 schools** (61 districts): Mean expenditure of [\$5,577,]{.mathjax_ignore} slightly higher than K–8 schools
- **K–8 schools** (359 districts): Mean expenditure of [\$5,267,]{.mathjax_ignore} with a larger sample size
- K–6 schools indicating higher variability, with a standard deviation of [\$662]{.mathjax_ignore} compared to [\$618]{.mathjax_ignore} for K-8 schools
