...
$$
y_t = \beta_1 + \beta_2 x_t + \delta_1 D_{t1} + \delta_{t2} D_{t2} + \delta_3 D_{t3} + \varepsilon_t ,
$$
...
Suppose that the data for the two independent groups are random samples from $N(\mu_1, \sigma^2)$ and $N(\mu_2, \sigma^2)$, respectively. Here we assume equal variance.
...
- the intercept $\color{#008B45FF}{\beta_0}$ ($2.79$) indicates that the expected log(earnings) for unmarried men is $2.79$;
