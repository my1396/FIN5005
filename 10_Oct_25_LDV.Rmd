...
- The heights of the boxes are proportional to percent developed. We can see that non-smokers' box for the developed on the left is much shorter than the smokers’ developed box on the right.
...
See Fig.&nbsp;\@ref(fig:logit-regression).
