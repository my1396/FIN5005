...
```{r paged.print=TRUE}
wcgs <- read.table("https://raw.githubusercontent.com/my1396/course_dataset/refs/heads/main/wcgs.txt", sep="\t", header=T, na.strings=".")
wcgs %>% head(20)
```
...
expcoef(fit.age)[-1,,drop=FALSE] %>% 
    kable(digits = 4, escape=T, caption = "Exponential of the coefficient and 95% CI.") %>% 
