...
5. Interpretation in context
   ...
   Expenditure has a statistically significant positive association with test scores at the 5% level. The point estimate implies that a [\$1,000]{.mathjax_ignore} increase in per-student expenditure is associated with about $0.005749\times 1000=5.75$ points higher test scores. 
:::
...
which corresponds to roughly 2.9 to 8.6 points per [\$1,000]{.mathjax_ignore}. 
